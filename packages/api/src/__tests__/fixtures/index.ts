...
export const sampleEnvelopes: Envelope[] = [
  ...
  },
  {
    ...
    envelope_type: EnvelopeType.SAVINGS,
    display_order: 3,
...
export const sampleTransactions: Transaction[] = [
  {
    ...
    from_envelope_id: undefined,
    to_envelope_id: undefined,
    payee_id: undefined,
    is_cleared: true,
    is_reconciled: false,
    is_deleted: false,
